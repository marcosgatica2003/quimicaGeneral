...
\begin{tikzpicture}[remember picture, overlay]
	...
	\node [line width=2pt] at (7.5cm, -9cm) {\includegraphics[width=6cm]{./imagenes/matrazCaratula.png}};
    ...
    \node at (7.5cm, -14cm) {\scalebox{3}{\textbf{Resumen de la materia}}};
    \node at (7.5cm, -25cm) {
	\begin{minipage}[c]{12cm}
	    \begin{itemize}
            ...
            \item \fontsize{12}{12}\selectfont \textbf{Asignatura:} Química General  \\
